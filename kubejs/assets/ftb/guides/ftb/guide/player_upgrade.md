...
* 10% Mining Speed (Max of 50%)


## <Color id="green">Quartermaster</Color>

* 10% Crit Chance (Max of 30%)
* 10% Dodge Chance (Max of 30%)
* 5% Life Steal (Max of 25%)


## <Color id="green">Machinist</Color>

* 25% Arrow Damage (Max of 100%)
* 10% Draw Speed (Max of 50%)
* 20% Attack Speed (Max of 100%)


## <Color id="light_purple">Magician</Color>

* +20 Max Ars Mana (Max of +200)
* 10% Cast Time Reduction for Iron's Spells (Max of 50%)
* 10% Cooldown Reduction for Iron's Spells (Max of 50%)
* +50 Max Iron's Mana (Max of +500)
* 25% Spell Power for Iron's Spells (Max of 200%)
* 25% Summon Damage for Iron's Spells (Max of 200%)